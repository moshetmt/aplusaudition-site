export const site = {
  ...
  horairesTable: [
    { jours: "Lundi à jeudi", heures: "9h30 – 18h30" },
    { jours: "Vendredi", heures: "9h – 14h" },
    { jours: "Samedi et dimanche", heures: "Fermé" },
  ],
  itineraire:
  ...
  laisserAvis: "https://g.page/r/CU3ammDptt54EBM/review",
  noteGoogle: "5,0",
  nbAvis: 18,
  nav: [
    { href: "/", label: "Accueil" },
